---
name: p2e-add-story
description: Explicit Codex entrypoint for the P2E add-story workflow. Thick by default — all thick-spec fields populated at add time. --thin opts out to fast placeholder capture.
---
