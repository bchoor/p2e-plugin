...
description: Explicit Codex entrypoint for the P2E verify-story workflow. Reproduces a P2E story's acceptance criteria against the running app, captures visible-pixel evidence, and outputs a self-contained rich-HTML UAT report.
---
