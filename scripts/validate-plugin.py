...
def validate_expected_files():
    ...
    expected_skill_paths = {
        ...
        ROOT / "skills" / "p2e-doc-reviewer-review" / "SKILL.md",
...
def validate_wrapper_references():
    workflow_map = {
        ...
        "commands/p2e-doc-reviewer-review.md": "workflows/p2e-doc-reviewer-review.md",
        ...
        "skills/p2e-doc-reviewer-review/SKILL.md": "workflows/p2e-doc-reviewer-review.md",
        ...
        ".cursor/skills/p2e-doc-reviewer-review/SKILL.md": "workflows/p2e-doc-reviewer-review.md",
    ...
    for router_path in router_paths:
        ...
        for workflow_ref in (
            ...
            "workflows/p2e-doc-reviewer-review.md",
        ):
            assert_true(
